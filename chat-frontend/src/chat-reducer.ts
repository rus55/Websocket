...
export const setClientName = (name: string) => (dispatch: any) => {api.sendName(name)}

export const typeMessage = () => (dispatch: any) => {api.typeMessage()}

export const sendMessage = (messages: string) => (dispatch: any) => {api.sendMessage(messages)}
